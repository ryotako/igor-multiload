...
// Functions for text wave matrix

//Function/WAVE DelRow(w,n)
//	WAVE/T w; Variable n
//	WAVE/T m = Matrix(w)
//	DeletePoints/M=0 n,1,m
//	return m
//End
//Function/WAVE DelCol(w,n)
//	WAVE/T w; Variable n
//	WAVE/T m = Matrix(w)
//	DeletePoints/M=1 n,1,m
//	return m
//End
//
//Function/WAVE GetRow(w,n)
//	WAVE/T w ;Variable n
//	Duplicate/FREE/T/R=[n,n][0,inf] Matrix(w) row
//	return row
//End
//Function/WAVE GetCol(w,n)
//	WAVE/T w ;Variable n
//	Duplicate/FREE/T/R=[0,inf][n,n] Matrix(w) col
//	return col
//End
//
//Function NumRows(w)
//	WAVE/T w
//	return DimSize(Matrix(w),0)
//End
//Function NumCols(w)
//	WAVE/T w
//	return DimSize(Matrix(w),1)
//End
//
//static Function/WAVE Matrix(w)
//	WAVE/T w
//	if(WaveExists(w))
//		Make/FREE/T/N=(DimSize(w,0),max(1,DimSize(w,1))) m=w[p][q]
//	else
//		Make/FREE/T/N=(0,0) m
//	endif
//	return m
